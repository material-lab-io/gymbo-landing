...
//
// 2026-09-07 (content, gy-oynyh): em-dash cleanup pass only, per founder ban
// (gy-yedub item 1). No claim, figure, tag, or citation was changed — every
// [Verified]/[Estimate] tag and every number is untouched. Only the dash
// character was replaced with a comma, colon, period, or parentheses, chosen
// per-instance to keep the original rhythm.
...
- **Platform listings (the floor):** Superprof (~21,370 listings), UrbanPro (~10,500+ across metros), and Alpha Coach (~5,500 profiles) yield **~24,000–26,000 unique trainers after de-duplicating ~30–35% cross-platform overlap.** [Verified listings + Estimate dedup]
- **Certification output (supply side):** India's certification bodies (K11 ~42,000 graduates over 22 years; IFSI 10,000+; Acfit/NASM 20,000+ educated) imply a **~80,000–100,000 total certified pool, of which ~30,000–40,000 are actively practising.** [Verified totals + Estimate active-rate]
- **US density adjusted (benchmark):** the US has ~104,000 independent trainers (370,000 trainers × 28% self-employed); adjusting for India's lower density gives **~28,000–44,000.** [Verified inputs + Estimate adjustment]
...
| Gurugram | ₹1,004–1,500/hr (highest) | N/A |
| Delhi | ₹942/hr | ~5,051 (UrbanPro) |
| Bengaluru | ₹965/hr | ~4,853 (UrbanPro) |
| **Online** | **₹1,808/hr** (premium for virtual) | N/A |
