...
const guideIndiaTrainers: Post = {
  ...
  dek: "Why the free WhatsApp-diary-UPI stack works for a while, and exactly where independent trainers in India watch it break.",
  date: "2026-06-23",
  metaTitle: "How India's Independent Personal Trainers Run Their Business | Gymbo",
  metaDescription:
    "Why independent personal trainers in India run their business on WhatsApp, a diary, and UPI, and the specific point where that free stack starts costing them money and hours.",
  faq: [
    {
...
## why it's a tooling problem, not a discipline problem
  ...
  faq: [
    {
      ...
      a: `It depends on your business. For a solo trainer in India tracking their own clients, sessions, and payments from an iPhone, an India-native, session-first tool like Gymbo fits well (UPI, GST, WhatsApp, ₹${PRICE_MONTHLY_INR}/mo). If you run a gym, Akton is built for facility management. If nutrition is your core offer, WellnessZ is nutrition-first. Global platforms like Trainerize and TrueCoach are strong but priced in dollars with no UPI, GST, or WhatsApp.`,
    },
    {
    ...
    },
    {
      ...
      a: `They range widely. Akton advertises from ₹89/mo (gym management). Gymbo is ₹${PRICE_MONTHLY_INR}/mo (₹${PRICE_ANNUAL_MONTHLY_EQUIVALENT_INR}/mo effective on annual). WellnessZ starts at ₹499/mo. The global tools are pricier for a real roster: Trainerize lands around ₹1,900+/mo and TrueCoach around ₹4,870/mo for a 5–20 client trainer, both in USD.`,
    },
    {
