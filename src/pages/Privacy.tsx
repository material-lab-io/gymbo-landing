      ...
      >
        ...
        <section className="flex flex-col gap-3">
          ...
          <ul>
            ...
            <li><strong>Data you enter about your clients.</strong> Client names, contact details, notes and goals, the classes you log, and the payments and balances you record. You enter this information, and you decide what to add.</li>
